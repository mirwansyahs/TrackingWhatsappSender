<div class="container-fluid">
    ...
    <div class="card card">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form method="POST" action="<?= base_url('admin/whatsapp/editProccess/'.$data->whatsapp_id) ?>">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <select name="whatsapp_vendor" class="form-control" id="whatsapp_vendor">
                            <?php for($i = 0; $i < count($arr); $i++) { ?>
                                <option value="<?=$arr[$i]?>" <?=($arr[$i] == $data->whatsapp_vendor)?'selected':''?>><?=$arr[$i]?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="form-group col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="whatsapp_authorized" name="whatsapp_authorized" placeholder="mRZ4CLne8XXXX" value="<?=$data->whatsapp_authorized?>">
                            </div>
                            <div class="col-md-3">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" id="whatsapp_label" name="whatsapp_label" value="<?=$data->whatsapp_label?>" readonly>
                    </div>
                </div>
            </div>
            <!-- /.card-body -->
